...
def record_playlist_items(filepath, developer_key, playlist_id):
  ...
  try:
    ...
    file = open("C:\\Users\\Jacqui.Muller\\OneDrive - NTT\\Archive\\Documents\\UiPath\\YouTube\\{}_log.txt".format(timestamp), "a+")
...
#record_playlist_items("items.xlsx", "AIzaSyAvNR9HTY5PUf4Saoscia08u4ioWY6hUd8", "PLtcIogydu_Bqb9Hgi1ULhCyJRTb27Fdee")